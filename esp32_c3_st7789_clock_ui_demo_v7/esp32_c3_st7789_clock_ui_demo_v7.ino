...
void drawCatIconCute(int x, int y) {
  tft.fillCircle(x + 16, y + 18, 10, C_CAT);
  tft.fillTriangle(x + 8, y + 10, x + 11, y + 2, x + 16, y + 10, C_CAT);
  tft.fillTriangle(x + 16, y + 10, x + 21, y + 2, x + 24, y + 10, C_CAT);
  tft.fillEllipse(x + 34, y + 24, 12, 9, C_CAT);
  tft.fillEllipse(x + 24, y + 28, 8, 6, C_CAT);
  tft.fillCircle(x + 12, y + 17, 1, C_BG);
  tft.fillCircle(x + 19, y + 17, 1, C_BG);
  tft.drawLine(x + 16, y + 20, x + 15, y + 22, C_BG);
  tft.drawLine(x + 16, y + 20, x + 17, y + 22, C_BG);
  tft.drawLine(x + 6, y + 18, x + 11, y + 19, C_CAT);
  tft.drawLine(x + 5, y + 22, x + 11, y + 21, C_CAT);
  tft.drawLine(x + 40, y + 15, x + 48, y + 10, C_CAT);
  tft.drawLine(x + 48, y + 10, x + 51, y + 15, C_CAT);
}
