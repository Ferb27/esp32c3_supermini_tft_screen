...
public:
  ...
  void drawStaticLayout(const WeatherData& weather, const DateTimeData& time, LayoutMode mode);
  void updateDynamicUI(const WeatherData& weather, const DateTimeData& time, LayoutMode mode, bool force = false);
